        ...
        <section className="relative py-20 overflow-hidden bg-slate-50">
            ...
            <div className="relative grid md:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <h1 className="text-5xl md:text-6xl font-black text-slate-900 leading-tight mb-6 font-display tracking-tight">
                    ...
                    <div className="flex gap-4">
                        <button className="px-8 py-4 bg-slate-900 text-white font-bold rounded-xl hover:bg-indigo-600 transition-all shadow-lg shadow-indigo-200">
                            Mua ngay
                        </button>
